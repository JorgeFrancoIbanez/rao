 ...
 *
 * ```js
 *   mraowebDev = angular.module('mraowebDev', ['mraoweb', 'ngMockE2E']);
 *   mraowebDev.run(function($httpBackend) {
...
if (window.jasmine || window.mocha) {
   ...
   * ```js
   *
   *   angular.module('mraoweblicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('Mraoweb', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('mraoweblicationModule'));
   *
   *
