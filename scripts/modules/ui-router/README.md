...
<head>
    ...
    <script>
        var mraoweb = angular.module('mraoweb', ['ui.router']);
        // For Component users, it should look like this:
        // var mraoweb = angular.module('mraoweb', [require('angular-ui-router')]);
    </script>
    ...
</head>
<body>
...
>
```javascript
mraoweb.config(function($stateProvider, $urlRouterProvider) {
  //
...
>
```javascript
mraoweb.config(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
